export default function Header() {
    return (
        <section id="header" className="border-b border-gray-800 py-4 px-3 sticky top-0 bg-[#121212] z-10 shadow-white">
            <header>
                <div className="flex justify-center items-center max-w-screen-l">
                    <nav className="flex space-x-4">
                        <a href="#hero" className="text-3xl hover:text-blue-500 transition=all duration-300">Home</a>
